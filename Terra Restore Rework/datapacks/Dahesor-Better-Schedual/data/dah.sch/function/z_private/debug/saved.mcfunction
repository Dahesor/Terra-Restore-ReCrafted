...
tellraw @a ["",{"text": " - 执行地点：","color": "green"},"大概位置：(",{"score": {"name": "x","objective": "dah.sch.ram"}}," ",{"score": {"name": "y","objective": "dah.sch.ram"}}," ",{"score": {"name": "z","objective": "dah.sch.ram"}},")  ",{"text":"查看详细位置","color": "aqua","underlined": true,"hover_event": {"action": "show_text","value": {"nbt":"stash[0].position","storage": "dah.sch:task","color": "white"}}}]
