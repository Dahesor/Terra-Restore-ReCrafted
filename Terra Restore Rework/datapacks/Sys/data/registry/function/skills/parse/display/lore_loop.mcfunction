...
execute if data storage registry:skill temp[0].lore[0].with run function registry:skills/parse/display/manage_var

#Loop
execute unless data storage registry:skill temp[1] run return fail
