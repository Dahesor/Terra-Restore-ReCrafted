...
attribute @s movement_speed modifier add sys:mob_speed_factor 0 add_multiplied_base
data modify entity @s attributes[{id:"minecraft:movement_speed"}].modifiers[{id:"sys:mob_speed_factor"}].amount set from storage temp factor.value