...
execute if score @s CD.off matches 1.. if score #loop_2 calculator matches 0 run scoreboard players remove @s CD.off 1
execute if score @s CD.right matches 1.. if score #loop_2 calculator matches 0 run scoreboard players remove @s CD.right 1
