...
execute unless score #new region = @s region run function sys:player/region_name/count_down
...
execute if score @s music matches ..-10 run function sys:player/music/get_play
scoreboard players remove @s region_name 1
execute if entity @s[tag=region_name,scores={region_name=0}] run function sys:player/region_name/specialize
