...
execute store result bossbar sys:boss_army max run attribute @e[type=zombie,tag=boss_army,limit=1] generic.max_health get
execute store result bossbar sys:boss_army_skele max run attribute @e[type=skeleton,tag=boss_army_skele,limit=1] generic.max_health get
execute store result bossbar sys:boss_army value run attribute @e[type=zombie,tag=boss_army,limit=1] generic.max_health get
execute store result bossbar sys:boss_army_skele value run attribute @e[type=skeleton,tag=boss_army_skele,limit=1] generic.max_health get
