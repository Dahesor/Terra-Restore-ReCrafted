...
data modify storage sys:loot_box test set value {id:0,players:[],loot:"sys:main/wool/lime",tags:["lime_wool"],display:{id:"lime_wool",count:1,components:{enchantment_glint_override:true}}}
