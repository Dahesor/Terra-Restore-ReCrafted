...
data modify storage sys:loot_box test set value {id:0,players:[],loot:"sys:main/loot/feather_falling",tags:["loot"],display:{id:"golden_boots",count:1,components:{enchantment_glint_override:true}}}
