...
data modify storage sys:loot_box test set value {id:0,locked:1b,players:[],loot:"sys:main/wool/purple",tags:["purple_wool","has_lock"],display:{id:"purple_wool",count:1,components:{enchantment_glint_override:true}}}
