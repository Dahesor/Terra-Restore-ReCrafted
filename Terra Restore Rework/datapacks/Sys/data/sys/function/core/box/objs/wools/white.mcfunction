...
data modify storage sys:loot_box test set value {id:0,players:[],loot:"sys:main/wool/white",tags:["white_wool"],display:{id:"white_wool",count:1,components:{enchantment_glint_override:true}}}
