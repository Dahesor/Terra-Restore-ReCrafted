...
data modify storage sys:loot_box test set value {id:0,players:[],loot:"sys:mob_drops/boss_army",tags:["boss_army","boss_drop","reward"],display:{id:"chest",count:1,components:{enchantment_glint_override:true}}}
