...
data modify storage sys:loot_box test set value {id:0,players:[],loot:"sys:main/loot/golden_apple",tags:["loot"],display:{id:"golden_apple",count:1,components:{enchantment_glint_override:false}}}
