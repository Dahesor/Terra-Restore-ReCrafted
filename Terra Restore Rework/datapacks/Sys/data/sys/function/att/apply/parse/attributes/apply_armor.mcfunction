$data modify storage sys:data item.components."minecraft:attribute_modifiers".modifiers append value {amount:0,id:"sys:att/$(diff)",operation:"add_value",type:"luck",slot:"armor"}
