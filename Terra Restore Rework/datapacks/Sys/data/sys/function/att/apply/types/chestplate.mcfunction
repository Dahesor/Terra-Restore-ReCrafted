...
#植入属性与说明
data modify storage data modifiers[].id set value "registry:weapon_type/chestplate"
data modify storage data additional_atts[].id set value "registry:prefix/chestplate"
data modify storage data modifiers append from storage data additional_atts[]
data modify storage data modifiers[].slot set value "chest"
