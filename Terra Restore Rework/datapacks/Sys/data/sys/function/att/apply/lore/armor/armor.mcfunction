execute if data storage sys:data item.components."minecraft:attribute_modifiers"[{id:"minecraft:armor.helmet",type:"minecraft:armor"}] store result score #temp calculator run data get storage sys:data item.components."minecraft:attribute_modifiers"[{id:"minecraft:armor.helmet",type:"minecraft:armor"}].amount 10
execute if data storage sys:data item.components."minecraft:attribute_modifiers"[{id:"minecraft:armor.chestplate",type:"minecraft:armor"}] store result score #temp calculator run data get storage sys:data item.components."minecraft:attribute_modifiers"[{id:"minecraft:armor.chestplate",type:"minecraft:armor"}].amount 10
execute if data storage sys:data item.components."minecraft:attribute_modifiers"[{id:"minecraft:armor.leggings",type:"minecraft:armor"}] store result score #temp calculator run data get storage sys:data item.components."minecraft:attribute_modifiers"[{id:"minecraft:armor.leggings",type:"minecraft:armor"}].amount 10
execute if data storage sys:data item.components."minecraft:attribute_modifiers"[{id:"minecraft:armor.boots",type:"minecraft:armor"}] store result score #temp calculator run data get storage sys:data item.components."minecraft:attribute_modifiers"[{id:"minecraft:armor.boots",type:"minecraft:armor"}].amount 10
