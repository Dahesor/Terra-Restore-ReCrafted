data modify storage temp run set value {trans:"attribute.name.generic.armor_toughness",value:0,mc:0}
...
function sys:att/apply/lore/armor/solo with storage temp run