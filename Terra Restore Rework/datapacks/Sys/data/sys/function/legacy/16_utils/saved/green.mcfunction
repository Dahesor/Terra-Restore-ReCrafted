execute if score 16_green data matches 1 run return fail

scoreboard players set 16_green data 1
tellraw @a[scores={region=17}] {"translate":"area.16.switch","color": "yellow"}
setblock 3109 134 881 minecraft:fire destroy
...
function dah.sch:set {time:20,run:'tellraw @a[scores={region=17}] {"translate":"area.17.save.green"}'}
