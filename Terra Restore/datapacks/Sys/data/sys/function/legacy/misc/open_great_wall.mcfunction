...
give @p cherry_sign[custom_name='{"text":"d"}',block_entity_data={id:"sign",is_waxed:true,front_text:{messages:['""','{"translate":"action.open_door","color": "aqua","clickEvent": {"action": "run_command","value": "/function sys:legacy/misc/open_great_wall"}}','""','["[",{"keybind": "key.use","underlined": true,"color": "green"},"]"]']}}]
