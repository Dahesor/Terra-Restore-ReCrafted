execute unless entity @s[tag=tpee] run return fail
...
execute if score #output calculator matches 1.. run function sys:core/tp/announce_end with storage sys:data test
tag @s remove tpee