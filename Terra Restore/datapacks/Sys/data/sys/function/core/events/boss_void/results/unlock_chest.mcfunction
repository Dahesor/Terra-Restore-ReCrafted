scoreboard players operation @s rolls.boss_void = boss_void_diff data
...
data modify storage sys:loot_box data[{tags:["boss_void"]}].players append from storage temp run