scoreboard players operation @s rolls.boss_wither = boss_army_diff data
...
data modify storage sys:loot_box data[{tags:["boss_wither"]}].players append from storage temp run