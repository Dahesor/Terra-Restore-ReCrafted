...
data modify storage sys:loot_box test set value {id:0,players:[],loot:"sys:main/loot/start",tags:["loot"],display:{id:"wooden_sword",count:1,components:{enchantment_glint_override:false}}}
