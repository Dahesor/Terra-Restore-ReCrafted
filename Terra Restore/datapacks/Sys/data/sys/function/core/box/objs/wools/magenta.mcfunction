...
data modify storage sys:loot_box test set value {id:0,players:[],loot:"sys:main/wool/magenta",tags:["magenta_wool"],display:{id:"magenta_wool",count:1,components:{enchantment_glint_override:true}}}
