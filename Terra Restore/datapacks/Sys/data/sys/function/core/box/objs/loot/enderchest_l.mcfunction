...
data modify storage sys:loot_box test set value {id:0,players:[],loot:"sys:main/loot/enderchest_l",tags:["ender_chest","loot"],display:{id:"ender_chest",count:1,components:{enchantment_glint_override:true}}}
