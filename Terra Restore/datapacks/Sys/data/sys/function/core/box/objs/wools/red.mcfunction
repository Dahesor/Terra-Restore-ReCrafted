...
data modify storage sys:loot_box test set value {id:0,locked:1b,players:[],loot:"sys:main/wool/red",tags:["red_wool","has_lock"],display:{id:"red_wool",count:1,components:{enchantment_glint_override:true}}}
