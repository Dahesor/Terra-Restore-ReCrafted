...
data modify storage sys:loot_box test set value {id:0,locked:1b,players:[],loot:"sys:main/wool/light_blue",tags:["light_blue_wool","has_lock"],display:{id:"light_blue_wool",count:1,components:{enchantment_glint_override:true}}}
