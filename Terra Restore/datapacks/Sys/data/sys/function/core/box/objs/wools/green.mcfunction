...
data modify storage sys:loot_box test set value {id:0,players:[],loot:"sys:main/wool/green",tags:["green_wool"],display:{id:"green_wool",count:1,components:{enchantment_glint_override:true}}}
