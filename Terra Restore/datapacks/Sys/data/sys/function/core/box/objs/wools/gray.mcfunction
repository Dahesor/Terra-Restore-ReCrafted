...
data modify storage sys:loot_box test set value {id:0,players:[],loot:"sys:main/wool/gray",tags:["gray_wool"],display:{id:"gray_wool",count:1,components:{enchantment_glint_override:true}}}
