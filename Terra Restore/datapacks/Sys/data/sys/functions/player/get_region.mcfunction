...
#忘却之地
execute if score #x calculator matches 791..1188 if score #z calculator matches -73..446 run return 100
...
#一号路口
execute if score #x calculator matches 435..759 if score #z calculator matches 62..197 run return 101
#追忆神木
...
#陵墓
execute if score #x calculator matches 2948..3140 if score #z calculator matches -854..56 run return 15
#干草牧场
execute if score #x calculator matches 2993..3288 if score #z calculator matches 56..532 run return 104
#菲瑞爾山
execute if score #x calculator matches 3000..3400 if score #z calculator matches 513..532 run return 16
#倪拉顿
