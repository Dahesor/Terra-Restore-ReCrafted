...
difficulty normal
function dah.sch:set {time:80,run:'tellraw @a [{"translate":"npc.vuco"}," ",{"translate":"storage.task"}]'}
function dah.sch:set {time:400,run:'tellraw @a [{"translate":"npc.vuco"}," ",{"translate":"storage.task.1"}]'}
