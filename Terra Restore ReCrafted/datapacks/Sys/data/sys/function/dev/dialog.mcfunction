dialog show @s {type:"multi_action",title:{text:"DEV"},actions:[\
{label:"启程之谷",action:{type:"run_command",command:"/execute in minecraft:overworld run tp @s 140.90 80.05 115.42 -1522.66 15.90"}},\
