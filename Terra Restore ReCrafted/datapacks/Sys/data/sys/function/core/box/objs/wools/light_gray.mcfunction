...
data modify storage sys:loot_box test set value {id:0,players:[],loot:"sys:main/wool/light_gray",tags:["light_gray_wool"],display:{id:"light_gray_wool",count:1,components:{enchantment_glint_override:true}}}
