...
data modify storage sys:loot_box test set value {id:0,players:[],loot:"sys:main/wool/yellow",tags:["yellow_wool"],display:{id:"yellow_wool",count:1,components:{enchantment_glint_override:true}}}
