...
data modify storage sys:loot_box test set value {id:0,players:[],loot:"sys:main/wool/cyan",tags:["cyan_wool"],display:{id:"cyan_wool",count:1,components:{enchantment_glint_override:true}}}
