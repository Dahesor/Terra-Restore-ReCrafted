...
data modify storage sys:loot_box test set value {id:0,players:[],loot:"sys:main/wool/brown",tags:["brown_wool"],display:{id:"brown_wool",count:1,components:{enchantment_glint_override:true}}}
