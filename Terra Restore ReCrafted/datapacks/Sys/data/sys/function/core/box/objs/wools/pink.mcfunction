...
data modify storage sys:loot_box test set value {id:0,players:[],loot:"sys:main/wool/pink",tags:["pink_wool"],display:{id:"pink_wool",count:1,components:{enchantment_glint_override:true}}}
