...
data modify storage sys:loot_box test set value {id:0,players:[],loot:"sys:main/wool/orange",tags:["orange_wool"],display:{id:"orange_wool",count:1,components:{enchantment_glint_override:true}}}
