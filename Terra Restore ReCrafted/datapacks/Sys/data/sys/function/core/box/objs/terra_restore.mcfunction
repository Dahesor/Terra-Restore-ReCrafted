...
$data modify storage sys:loot_box test set value {id:0,players:[],loot:"sys:main/terra_restore/$(id)",tags:["terra_restore","terra_$(id)"],display:{id:"sponge",count:1,components:{enchantment_glint_override:true}}}
