...
execute if score @s region matches 200 if score #new region matches 8 run return fail
execute if score @s region matches 8 if score #new region matches 200 run return fail
