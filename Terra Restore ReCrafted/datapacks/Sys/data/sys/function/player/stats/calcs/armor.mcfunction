...
data modify storage dah:actbar new set value {id:"armor_20",text:[{text:"qW",font:"terra:hud"},{text:"m"},{text:"*"},{text:"m"},{text:"*"},{text:"m"},{text:"*"},{text:"m"},{text:"*"},{text:"m"},{text:"*"},{text:"m"},{text:"*"},{text:"m"},{text:"*"},{text:"m"},{text:"*"},{text:"m"},{text:"*"},{text:"m"},{text:"Qq"}]}
