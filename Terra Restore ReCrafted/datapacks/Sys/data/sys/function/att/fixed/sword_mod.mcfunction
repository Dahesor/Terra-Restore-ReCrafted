...
$data modify storage data selected_type set from storage data class[{id:"$(type)"}]
...
#获取可用前缀
$data modify storage data prefixs append from storage registry:prefix data[{for:["$(weapon)"]}]
$data modify storage data pr set from storage data prefixs[{id:"$(prefix)"}]
