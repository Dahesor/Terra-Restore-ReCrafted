...
scoreboard players operation $hp dah.Bcalc = @s dfh.HP
scoreboard players operation $hp dah.Bcalc /= #10 dah.Bcalc

scoreboard players operation @s dah.Bcalc = @s dfh.Absorb
scoreboard players operation @s dah.Bcalc /= #10 dah.Bcalc
...
scoreboard players operation @s dah.Bcalc = @s dfh.Absorb
execute if score @s dah.Bcalc matches 1.. run data modify storage dah.below:m t.format set value {"text":"d","font":"dah.below:icon",shadow_color:0}
